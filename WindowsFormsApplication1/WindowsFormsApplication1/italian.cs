...
{
    public partial class italian : Form
    {
        public italian()
        {
            InitializeComponent();
            this.Text = "Romeo Restaurant";
            ...
            //history control
            if (history.italian_xartis == true)
            {
                button2.BackColor = Color.LightGreen;
            }
            if(history.italian_kratisi == true)
            {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            history.italian_xartis = false;
            button3.BackColor = SystemColors.Control;
            button3.UseVisualStyleBackColor = true;
            history.italian_kratisi = false;
