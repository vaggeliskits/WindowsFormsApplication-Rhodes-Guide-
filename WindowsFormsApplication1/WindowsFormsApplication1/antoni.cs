...
{
    public partial class antoni : Form
    {
        public antoni()
        {
            InitializeComponent();
            this.Text = "Άντονυ Κουίν";
            ...
            //history control
            if (history.antoni_lipsi == true)
            {
                button8.BackColor = Color.LightGreen;
            }
            if(history.antoni_play == true)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Form1.user == true)
            {
                ...
                else
                {
                    ...
                    axWindowsMediaPlayer1.URL = @"videos/antoni.mp4";
                    axWindowsMediaPlayer1.Ctlcontrols.play();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                button8.BackColor = Color.LightGreen;
                history.antoni_lipsi = true;
                string dir = @"../../txt_file/";
                string filename = "antoni.txt";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            history.antoni_lipsi = false;
            button1.BackColor = SystemColors.Control;
            button1.UseVisualStyleBackColor = true;
            history.antoni_play = false;
