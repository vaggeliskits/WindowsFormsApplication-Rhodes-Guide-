...
{
    public partial class paliapoli : Form
    {

        public paliapoli()
        {
            InitializeComponent();
            this.Text = "Παλιά Πόλη";
            ...
            //history control
            if (history.paliapoli_lipsi == true)
            {
                button9.BackColor = Color.LightGreen;
            }
            if(history.paliapoli_play == true)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if(Form1.user == true)
            {
                ...
                else
                {
                    ...
                    axWindowsMediaPlayer1.URL = @"videos/palia_poli.mp4";
                    axWindowsMediaPlayer1.Ctlcontrols.play();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if(Form1.user == true)
            {
                history.paliapoli_lipsi = true;
                button9.BackColor = Color.LightGreen;
                string dir = @"../../txt_file/";
                string filename = "palia_poli.txt";
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            history.paliapoli_lipsi = false;
            button4.BackColor = SystemColors.Control;
            button4.UseVisualStyleBackColor = true;
            history.paliapoli_play = false;
            button10.BackColor = SystemColors.Control;
            button10.UseVisualStyleBackColor = true;
            history.paliapoli_sxo = false;
        }
