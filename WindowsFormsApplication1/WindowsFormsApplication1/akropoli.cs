...
{
    public partial class akropoli : Form
    {
        public akropoli()
        {
            InitializeComponent();
            ...
            //history control
            if (history.akropoli_lipsi == true)
            {
                button7.BackColor = Color.LightGreen;
            }
            if(history.akropoli_play == true)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (Form1.user == true)
            {
                ...
                else
                {
                    ...
                    axWindowsMediaPlayer1.URL = @"videos/akropoli.mp4";
                    axWindowsMediaPlayer1.Ctlcontrols.play();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                button7.BackColor = Color.LightGreen;
                history.akropoli_lipsi = true;
                string dir = @"../../txt_file/";
                string filename = "akropoli.txt";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            history.akropoli_lipsi = false;
            button4.BackColor = SystemColors.Control;
            button4.UseVisualStyleBackColor = true;
            history.akropoli_play = false;
            button10.BackColor = SystemColors.Control;
            button10.UseVisualStyleBackColor = true;
            history.akropoli_sxo = false;
        }
