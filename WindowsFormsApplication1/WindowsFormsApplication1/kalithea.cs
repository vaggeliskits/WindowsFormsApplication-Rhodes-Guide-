...
{
    public partial class kalithea : Form
    {
        public kalithea()
        {
            InitializeComponent();
            ...
            //history control
            if (history.kalithea_lipsi == true)
            {
                button8.BackColor = Color.LightGreen;
            }
            if(history.kalithea_play == true)
            {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (Form1.user == true)
            {
                ...
                else
                {
                    ...
                    axWindowsMediaPlayer1.URL = @"videos/kalithea.mp4";
                    axWindowsMediaPlayer1.Ctlcontrols.play();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                button8.BackColor = Color.LightGreen;
                history.kalithea_lipsi = true;
                string dir = @"../../txt_file/";
                string filename = "kalithea.txt";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            history.kalithea_lipsi = false;
            button5.BackColor = SystemColors.Control;
            button5.UseVisualStyleBackColor = true;
            history.kalithea_play = false;
